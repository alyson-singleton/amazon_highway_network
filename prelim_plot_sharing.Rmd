...
## Figure 2: Open Street Map roads
...
## Figure 3: Globel Road Inventory Project (GRIP4) roads

The first plot shows all roads in the Amazon basin, and the second plot shows all roads that GRIP designated as paved as of 2011. Note that some of the roads shown below were removed from Figure 1 after the validation step (i.e., they do not actually exist).
